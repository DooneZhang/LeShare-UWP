...
var appId = 'PVEQkrq2BHvDgM6q0xpGd1gw-gzGzoHsz';
var appKey = 'gtkrIk7VPDcy44Dw5hT3vsMj';

AV.initialize(appId, appKey);

// 请换成你自己的一个房间的 conversation id（这是服务器端生成的）
var roomId = '5863ead01b69e675fcdf9670';
...
function main() {
  ...
  .then(function(conversation) {
    showLog('当前所选的账号类别为：', conversation.members);
